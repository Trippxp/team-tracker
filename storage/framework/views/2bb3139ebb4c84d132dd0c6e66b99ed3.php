...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Team Activity Tracker'); ?> — Npontu Technologies</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('activities.index')); ?>" class="nav-link <?php echo e(request()->routeIs('activities.*') ? 'active' : ''); ?>">
            <i class="bi bi-list-task"></i> Daily Activities
        </a>
        <?php if(auth()->user()->isAdmin()): ?>
        <a href="<?php echo e(route('activities.create')); ?>" class="nav-link <?php echo e(request()->routeIs('activities.create') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        &copy; <?php echo e(date('Y')); ?> Npontu Technologies
    </div>
</aside>
    ...
    <header class="topbar">
        ...
        <div class="user-badge">
            ...
            <div>
                ...
                <div style="font-size:.75rem; color:#999;"><?php echo e(ucfirst(auth()->user()->role)); ?> &middot; <?php echo e(auth()->user()->department); ?></div>
            </div>
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="ms-2">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\CYRIL\Desktop\team-tracker\resources\views/layouts/app.blade.php ENDPATH**/ ?>